...
from ss_portfolio import block_sharpe_with_costs
...
def train(
    ...
    *,
    ...
    divergence_fn = get_divergence(divergence)

    def _sharpe(params, slc):
        scores = divergence_fn(
    ...
    print(f'Optimizing {len(scales) + 1} params with JAX Adam '
          f'(n_steps={n_steps}, lr={learning_rate}, divergence={divergence})...')
