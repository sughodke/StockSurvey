...
- ~~[Meta-allocator with strategy-internal features](meta-allocator-internal-features.md)~~ — **DONE 2026-05-28** `confirmed-null` vs locked pre-reg bar. 3-trial grid (D1 ridge, D2 RBF kernel ridge per pre-reg license for D2 RF-depth-3, D3 PCA-2-PC) over 14 strategy-internal features at quarterly cadence on the 6-arc panel; model* (D2 kernel ridge, in-train Sh +1.14) fold-3 OOS Sh +2.83 vs B3 +4.15 (ΔSR_ann −1.39 [−2.40, −0.28] excludes 0 negative) vs canonical DCA+2×vol_v3 +5.94 (ΔSR_ann −3.29 [−4.93, −1.70] excludes 0 negative); 2024+ slice ΔSR vs canonical −4.61 [−6.78, −2.43] excludes 0. **Closes the meta-allocator arc** — cadence × input-class × learner levers all exhausted (monthly + macro reversed-OOS 2026-05-23; quarterly + internal-features confirmed-null here). Deployment recipe remains canonical DCA + 2×vol_v3 sleeve. See [`findings/meta-allocator-internal-features`](../findings/meta-allocator-internal-features.md).
