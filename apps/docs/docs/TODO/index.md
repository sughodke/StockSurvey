...
- [Factor short-horizon edge — microstructure/cost stress — pre-registered skip-1 implementation-lag test of the `confirmed-OOS` 5d indicator edge (is +0.0212 IC a tradable move or bid-ask bounce?); gates universe-generalization + decay](factor-shorthorizon-microstructure.md)
