...
- [Follow-the-leader v1 — cross-sectional consensus arm (pre-reg locked cell h=30/k=10/frequency on the all-members cohort with `filed+1` entry; 3 folds with fold-3 2025-26 as unseen verdict slice; spawned by v0 leadership-arm `confirmed-null`)](follow-consensus-arm.md)
