...
| [`dca`](dca.md) | **Live (canonical)** 2026-05-13 | Multi-asset DCA — 13-ETF equal-weight basket on Phase 4d's universe (9 SPDR sector ETFs + TLT/IEF + GLD/DBC). 1/13 = 7.6923% per name, quarterly rebal (80 trading-day cadence floor) with 5% per-name drift threshold for off-cadence triggers. 5 risk rails (kill-switch, freshness, cadence/drift gate, per-name cap, dry-run-by-default). Backtest 2005-2025: Sharpe +0.673, CAGR +8.4%, max DD −40.7% (GFC). Bias-corrected Sharpe ~+0.55 after bond-tailwind discount. Built on `ss_portfolio.broker.AlpacaBroker`. The deployable winner of the cfr-vs-dca realistic-friction comparison. |
