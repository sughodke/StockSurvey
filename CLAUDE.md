...
- `apps/pairs/`      — pair-spread mean reversion. Engle-Granger cointegration screening (per train slice) + classical z-score-crossing trade rules on dollar-neutral pair trades. Numpy + statsmodels. Second test of the prediction-problem pivot. Walk-forward result pending.
